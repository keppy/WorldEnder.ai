...
class World(BaseModel):
    ...
    """
    current_location: Location = Field(None, description="The current location of the player")
    population: int = Field(CURRENT_WORLD_POP, description="The population of the world")
    day: int = Field(0, description="The number of days that have passed in the game")
    log_multiplier: int = Field(LOG_MULTIPLIER, description="The log multiplier for the population decrease")
    epoch: Literal["Apocalyptic", "Post-Apocalyptic", "Post-Post-Apocalyptic"] = "Apocalyptic"
